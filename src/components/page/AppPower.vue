        ...
        <div class="app-container">
            <div class="box">
                ...
                <el-table :data="dataList" size="small" current-row-key="id" stripe highlight-current-row>
                    ...
                    <el-table-column prop="username" label="功能名" align="center" />
                    <el-table-column prop="truename" label="菜单代码" align="center" />
                    <el-table-column prop="telNum" label="菜单名" align="center" />
                ...
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增app权限">
                ...
                <!-- 编辑标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="编辑app权限">
