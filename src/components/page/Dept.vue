    ...
    <div class="app">
        ...
        <div class="app-container">
            <div class="box">
                ...
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增部门">
                ...
                <!-- 编辑标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="编辑部门">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    // 校验规则
                    deptid: [{ required: true, message: '部门编码为必填项', trigger: 'blur' }],
