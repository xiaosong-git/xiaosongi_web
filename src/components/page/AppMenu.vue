        ...
        <div class="content-header">
            <div class="filter-container">
                ...
                <el-input v-model="pagination.queryString" placeholder="电话" style="width: 200px;"
                          class="filter-item"/>
                <el-button class="dalfBut" @click="">查询</el-button>
        ...
        <div class="app-container">
            <div class="box">
                <el-table :data="dataList" size="small" v-loading="listLoading"
                    ...
                    <el-table-column prop="function_name" align="center" label="功能名"/>
                    <el-table-column prop="menu_code" label="菜单代码" align="center"/>
                    <el-table-column prop="menu_name" label="菜单名" align="center"/>
                    <el-table-column prop="menu_url" label="菜单地址" align="center"/>
                    <el-table-column prop="istop" label="是否制定" align="center"/>
                    <el-table-column prop="menu_icon" label="菜单控件图地址" align="center"/>
                    <el-table-column prop="relation_no" label="菜单关联" align="center"/>
                    <el-table-column prop="sstatus" label="菜单状态" align="center"/>
                ...
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增用户">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"
                            ...
                            <el-row>
                                <el-col :span="10">
                                    <el-form-item label="功能名:" prop="function_name">
                                        <el-input v-model="formData.function_name"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="菜单代码:" prop="menu_code">
                                        <el-input v-model="formData.menu_code"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                ...
                                <el-col :span="10">
                                    <el-form-item label="是否制定:" prop="istop">
                                        <el-input v-model="formData.istop"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="菜单控件图地址:" prop="menu_icon">
                                        <el-input v-model="formData.menu_icon"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="菜单关联:" prop="relation_no">
                                        <el-input v-model="formData.relation_no"/>
                                    </el-form-item>
                                </el-col>  <el-col :span="10">
                                <el-form-item label="菜单状态:" prop="sstatus">
                                    <el-input v-model="formData.sstatus"/>
                                </el-form-item>
                            </el-col>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    // 校验规则
                    function_name: [{required: true, message: '功能名', trigger: 'blur'}],
                    menu_code: [{required: true, message: '菜单代码', trigger: 'blur'}],
                    menu_name: [{required: true, message: '菜单名', trigger: 'blur'}],
                    menu_url: [{required: true, message: '菜单地址', trigger: 'blur'}],
                    istop: [{required: true, message: '是否制定', trigger: 'blur'}],
                    menu_icon: [{required: true, message: '菜单控件图地址', trigger: 'blur'}],
                    relation_no: [{required: true, message: '菜单关联', trigger: 'blur'}],
                    sstatus: [{required: true, message: '菜单状态', trigger: 'blur'}],
                }
            };
        },
        created() {
