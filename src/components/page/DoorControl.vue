        ...
        <div class="app-container">
            <div class="box">
                ...
                <el-table :data="dataList" size="small" current-row-key="id" stripe highlight-current-row>
                    ...
                    <el-table-column prop="codeIP" label="IP地址" align="center"/>
                    ...
                    <el-table-column prop="gate" label="控制闸机" align="center"/>
                    <el-table-column prop="floors" label="控制楼层" align="center"/>
                ...
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增门禁控制项">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"
                                 label-width="100px">
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="IP地址" prop="codeIP">
                                        <el-input v-model="formData.codeIP"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="控制闸机" prop="gate">
                            ...
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="控制楼层" prop="floors">
                ...
                <!-- 编辑标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="编辑门禁控制">
                        <el-form ref="dataEditForm" :model="formData" :rules="rules" label-position="right"
                                 label-width="100px">
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="IP地址" prop="code">
                                        <el-input v-model="formData.codeIP"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="控制闸机" prop="name">
                                        <el-input v-model="formData.gate"/>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="控制楼层" prop="code">
                                        <el-input v-model="formData.floors"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    // 校验规则
                    codeIP: [{ required: true, message: 'IP地址为必填项', trigger: 'blur' }],
                    name: [{ required: true, message: '设备名称为必填项', trigger: 'blur' }],
                    type: [{ required: true, message: '设备类型为必填项', trigger: 'blur' }],
                    gate: [{ required: true, message: '控制闸机为必填项', trigger: 'blur' }],
                    floors: [{ required: true, message: '控制楼层为必填项', trigger: 'blur' }],
