        ...
        <div class="app-container">
            <div class="box">
                <div class="filter-container">
                    <el-input v-model="pagination.queryString" placeholder="设备名称" style="width: 200px;" class="filter-item" />
                ...
                <el-table :data="dataList" size="small" current-row-key="id" stripe highlight-current-row>
                    ...
                    <el-table-column prop="id" label="厂家id" align="center" />
                    <el-table-column prop="type" label="设备型号" align="center" />
                    <el-table-column prop="standards" label="设备规格" align="center" />
                ...
                <div class="pagination-container">
                    <el-pagination :current-page="pagination.currentPage" :page-size="pagination.pageSize" :total="pagination.total" class="pagiantion" layout="total, prev, pager, next, jumper" @current-change="handleCurrentChange" />
                </div>
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增设备">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right" label-width="100px">
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="厂家id" prop="id">
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="设备规格" prop="standards">
                                        <el-input v-model="formData.standards" />
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                ...
                <!-- 编辑标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="编辑设备">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    // 校验规则
                    id: [{ required: true, message: '厂家id为必填项', trigger: 'blur' }],
                    name: [{ required: true, message: '设备名称为必填项', trigger: 'blur' }],
                    type: [{ required: true, message: '设备型号为必填项', trigger: 'blur' }],
                    standards: [{ required: true, message: '设备规格为必填项', trigger: 'blur' }],
