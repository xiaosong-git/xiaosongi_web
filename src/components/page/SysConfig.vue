        ...
        <div class="app-container">
            <div class="box">
                <el-table :data="dataList" size="small" v-loading="listLoading"
                    ...
                    <el-table-column prop="function_name" align="center" label="对应子系统名称"/>
                ...
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增用户">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"
                            ...
                            <el-row>
                                <el-col :span="10">
                                    <el-form-item label="对应子系统名称:" prop="function_name">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    // 校验规则
                    function_name: [{required: true, message: '对应子系统名称', trigger: 'blur'}],
        ...
        methods: {
            ...
            findPage() {
                ...
                this.listLoading = true,
                    selectSysConfig(param).then(res => {
                        // alert(res.size)
