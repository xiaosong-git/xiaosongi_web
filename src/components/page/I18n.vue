    ...
    <div>
        ...
        <div class="container form02" >
            <el-form :label-position="labelPosition" :rules="rules" ref="form02" :label-width="labelWidth" :inline="false" :model="form2" class="demo-form-inline">
                <el-form-item label="考勤类型" prop="name">
                    <!--<el-input v-model="form2.name" placeholder="审批人"></el-input>-->
                    <el-select v-model="form2.name" placeholder="请选择">
                        <el-option label="门禁" value="shanghai"></el-option>
                        <el-option label="考勤" value="beijing"></el-option>
                    </el-select>
                </el-form-item>
                <!--<el-form-item label="上下班打卡" prop="amount">
                ...
                <el-form-item label="最早打卡时间">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
                </el-form-item>
                ...
                <el-form-item label="可允许最晚时间">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
                </el-form-item>



                <el-form-item label="下班时间:AM">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
                </el-form-item>
                <el-form-item label="可允许最晚打卡时间">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
                </el-form-item>
                <el-form-item label="下午上班时间" style="width:300px;">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
                </el-form-item>
                <el-form-item label="下班时间:PM">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
                </el-form-item>
                <el-form-item label="可允许最晚打卡时间">
                    <el-input v-model="form2.user" placeholder="请输入时间"></el-input>
